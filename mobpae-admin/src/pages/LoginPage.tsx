...
const features = [
  ...
  { icon: "⊞", label: "User Management",         sub: "Roles, permissions, teams"       },
  { icon: "▲", label: "Platform Analytics",      sub: "Real-time system metrics"        },
  { icon: "⚙", label: "System Configuration",   sub: "Integrations, billing, settings" },
];
    ...
    <div style={{ display: "flex", height: "100vh", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        <div style={{ padding: "28px 40px", position: "relative", zIndex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
            <svg width="28" height="28" viewBox="0 0 100 100" fill="none" aria-hidden="true">
              <defs><clipPath id="lp-clip"><rect width="100" height="100" rx="20" ry="20"/></clipPath></defs>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 48px", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, border: "1px solid rgba(118,121,255,0.35)", borderRadius: 999, padding: "5px 14px", width: "fit-content", marginBottom: 32, background: "rgba(118,121,255,0.10)" }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 600, color: "#A5A7FF", letterSpacing: "0.10em", textTransform: "uppercase" }}>Admin Portal</span>
          </div>

          {/* Headline */}
          <h1 style={{ fontSize: 48, fontWeight: 800, color: "white", lineHeight: 1.08, letterSpacing: "-0.03em", margin: "0 0 20px" }}>
            System<br />
            <em style={{ fontStyle: "italic", fontWeight: 400, color: "rgba(255,255,255,0.50)" }}>control</em><br />
            at scale.
          </h1>

          <p style={{ fontSize: 14, color: "rgba(255,255,255,0.45)", lineHeight: 1.7, maxWidth: 340, marginBottom: 40 }}>
            Full platform oversight, compliance management, and enterprise controls — built for the people who run MobPae.
          </p>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.40)" }}>Protected admin workspace</span>
          </div>
      ...
      <div style={{
        ...
        <div style={{ padding: "28px 48px", display: "flex", justifyContent: "flex-end" }}>
          <span style={{ fontSize: 12, color: "#8D90A3" }}>Secure Admin Access</span>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 64px 40px" }}>
          <div style={{ maxWidth: 380, width: "100%", margin: "0 auto" }}>
            ...
            <div style={{ display: "inline-flex", alignItems: "center", gap: 7, background: "rgba(118,121,255,0.10)", border: "1px solid rgba(118,121,255,0.25)", borderRadius: 999, padding: "5px 14px", marginBottom: 28 }}>
              ...
              <span style={{ fontSize: 11, fontWeight: 600, color: BD, letterSpacing: "0.10em", textTransform: "uppercase" }}>Admin Access</span>
            </div>
            ...
            <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              {/* Email */}
              <div>
                <label style={{ display: "block", fontSize: 13, fontWeight: 600, color: "#191A2E", marginBottom: 8 }}>Admin Email</label>
                <div style={{
              ...
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
                  ...
                  <button type="button" onClick={() => navigate("/forgot-password")} style={{ fontSize: 13, color: BD, fontWeight: 600, background: "none", border: "none", cursor: "pointer", padding: 0 }}>Forgot password?</button>
                </div>
                <div style={{
                  display: "flex", alignItems: "center", gap: 10,
                  background: "white", border: "1.5px solid #E4E4EF", borderRadius: 10, padding: "11px 14px",
