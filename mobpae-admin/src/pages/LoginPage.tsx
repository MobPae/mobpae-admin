      ...
      <div style={{
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 48px", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, border: "1px solid rgba(255,255,255,0.30)", borderRadius: 999, padding: "5px 14px", width: "fit-content", marginBottom: 32 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 600, color: "rgba(255,255,255,0.75)", letterSpacing: "0.10em", textTransform: "uppercase" }}>Admin Portal</span>
          </div>

          {/* Headline */}
          <h1 style={{ fontSize: 52, fontWeight: 800, color: "white", lineHeight: 1.08, letterSpacing: "-0.03em", margin: "0 0 20px" }}>
            System<br />
            <em style={{ fontStyle: "italic", fontWeight: 400, color: "rgba(255,255,255,0.70)" }}>control</em><br />
            at scale.
          </h1>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <span style={{ fontSize: 12, color: "rgba(255,255,255,0.50)" }}>All systems operational</span>
          </div>
          <span style={{ fontSize: 11, color: "rgba(255,255,255,0.30)", letterSpacing: "0.04em" }}>v4.2.1</span>
        </div>
      </div>
