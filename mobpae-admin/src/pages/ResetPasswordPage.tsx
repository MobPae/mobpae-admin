          ...
          <div>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: "0 4px 16px rgba(196,82,42,0.30)",
              }}
            >
              Sign in
            </button>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, background: "white", border: "1.5px solid #e8e0d8", borderRadius: 10, padding: "11px 14px", transition: "border-color 0.15s" }}>
                  ...
                  />
                  <button type="button" onClick={() => setShowNew(v => !v)} style={{ color: "#bbb", background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex" }}>
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10, background: "white", border: "1.5px solid #e8e0d8", borderRadius: 10, padding: "11px 14px", transition: "border-color 0.15s" }}>
                  ...
                  <input
                    ...
                    onBlur={e  => { (e.target.closest("div") as HTMLElement).style.borderColor = "#e8e0d8"; }}
                  />
                  <button type="button" onClick={() => setShowConfirm(v => !v)} style={{ color: "#bbb", background: "none", border: "none", cursor: "pointer", padding: 0, display: "flex" }}>
