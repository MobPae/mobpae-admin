                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      <p className="text-[12px] font-[500] text-slate-900 truncate leading-none">{doc.employee.name}</p>
                      <p className="text-[10px] text-slate-400 font-mono mt-0.5 leading-none">{doc.employee.employeeCode}</p>
                    </div>
                  </div>
                </td>
                <td className="px-4 py-3">
                  <span className="text-[11px] text-slate-500 truncate block">{doc.employee.email}</span>
                </td>
                <td className="px-4 py-3">
                  <p className="text-[12px] font-[500] text-slate-700 truncate leading-none">{doc.employee.employer.companyName}</p>
                  <p className="text-[10px] font-mono text-slate-400 mt-0.5 leading-none">{doc.employee.employer.companyCode}</p>
                </td>
                <td className="px-4 py-3">
                  <span className="text-[11px] font-[500] text-slate-700">{DOC_LABEL[doc.documentType] ?? doc.documentType}</span>
                </td>
                <td className="px-4 py-3">
                  {sc && (
