      ...
      <div className="fixed top-0 right-0 h-full w-[440px] bg-white z-50 flex flex-col border-l border-edge shadow-overlay">
        ...
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-edge flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-[13px] font-[500] text-ink leading-none">{account.employee.name}</p>
              <p className="text-[11px] text-ink-3 mt-0.5 leading-none">{account.employee.employer.companyName}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            <span className={`inline-flex h-[18px] px-1.5 rounded-[3px] items-center text-[11px] font-[500] ${account.verified ? "bg-success-bg text-success-dark" : "bg-amber-50 text-amber-700"}`}>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-5">
          ...
          <section>
            <p className="text-[11px] font-[500] uppercase tracking-[0.07em] text-ink-3 mb-2">Bank account</p>
          ...
          {account.verified && (
            <div className="bg-brand-soft rounded-md px-3 py-2.5 border border-[#EEF2FF]">
